...
interface Router extends SwitchableComponent
{
    ...
    // @todo Router should returna Response that emulates a 404 error if the current request does not exist in storage.
    //       This will prevent responses that are assinged requests that dont exist from being returned
