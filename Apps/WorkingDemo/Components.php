...
/***** StandardUITemplates *****/
$workingDemoDefaultTemplate = new \DarlingCms\classes\component\Template\UserInterface\StandardUITemplate(
    new Storable(
...
// Request
$workingDemoDefaultRequest = new \DarlingCms\classes\component\Web\Routing\Request(
    new Storable(
...
// Response
$workingDemoDefaultResponse = new \DarlingCms\classes\component\Web\Routing\Response(
    new Storable(
